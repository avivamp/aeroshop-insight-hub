import { Search, Clock, MousePointer, DollarSign, AlertTriangle, Globe } from "lucide-react";
...
export default function AISearchAnalytics() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-foreground mb-2">AI & Search Analytics</h1>
